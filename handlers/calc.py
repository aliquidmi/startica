...
# Допустимі символи: цифри, + - * / ( ) і пробіли
...
def safe_eval(expr: str) -> float:
    # Виконання обчислення з eval, якщо вираз безпечний
...
async def calc_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not expr:
        await update.message.reply_text("Введи вираз після /calc. Наприклад: `/calc 2 + 2 * (3 - 1)`", parse_mode='Markdown')
        return
